    ...
    public <T> T clone(T object) {
        ...
        if (object instanceof Map) {
            ...
            if (firstEntry != null) {
                ...
                if (!(key instanceof Serializable) || !(value instanceof Serializable)) {
                    JavaType type =
                            TypeFactory.defaultInstance().constructParametricType(object.getClass(), key.getClass(), value.getClass());
        ...
        if (object instanceof Serializable) {
            try {
                ...
                // it is possible that object itself implements java.io.Serializable, but underlying structure does
                // not
